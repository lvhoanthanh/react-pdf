...
- **Code**: take a look at the [open issues](https://github.com/lvhoanthanh/react-pdf/issues). Even if you can't write code, commenting on them, showing that you care about a given issue matters. It helps us triage them.
...
```sh
git clone https://github.com/lvhoanthanh/react-pdf.git
cd react-pdf
```
...
If you have any questions, create an [issue](https://github.com/lvhoanthanh/react-pdf/issues) (protip: do a quick search first to see if someone else didn't ask the same question before!).
...
<a href="/lvhoanthanh/react-pdf/graphs/contributors"><img src="https://opencollective.com/react-pdf/contributors.svg?width=890" /></a>
